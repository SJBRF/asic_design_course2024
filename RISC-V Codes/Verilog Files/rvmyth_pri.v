  ...
  // $clk_pri = *clk;
   ...
   //_|cpu
      ...
      //_@1
         ...
         assign CPU_imem_rd_en_a1 = !(CPU_reset_a2);
	 ...
	 // Branch Instruction
      ...
      //_@2
         //Register file read
         assign CPU_rf_rd_en1_a2 = CPU_rs1_valid_a2 && CPU_result_a4 ;
         assign CPU_rf_rd_index1_a2[4:0] = CPU_rs1_a2 ;
         assign CPU_rf_rd_en2_a2 = CPU_rs2_valid_a2 && CPU_result_a4;
   ...
   /*SV_plus*/
      always @ (posedge clk_pri) begin
         OUT = CPU_Xreg_value_a3[15];                
      end
   
   //_|cpu
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 16   // Instantiated from rvmyth.tlv, 268 as: m4+imem(@1)
      ...
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 31   // Instantiated from rvmyth.tlv, 269 as: m4+rf(@2, @3)
         // Reg File
         //_@3
      ...
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 48   // Instantiated from rvmyth.tlv, 270 as: m4+dmem(@4)
         // Data Memory
         //_@4
...
// Undefine macros defined by SandPiper (in "rvmyth_pri_gen.v").
`undef BOGUS_USE
